...
export default defineEventHandler(async(event) => {
    ...
    if(!categoryId) {
        ...
        let error = false;
        await axios.post(`${runtimeConfig.public.apiBase}/product-listing/${categoryId}`, {}, { headers: { 'sw-access-key': runtimeConfig.apiKey, 'sw-include-seo-urls': 1, 'sw-include-options': 1 } })
        .then((response) => {
